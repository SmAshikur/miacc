       ...
       <div id="app" class="my-5">
        ...
        {{-- <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">Head Component</div>
                        <div class="card-body p-5">
                            <form action="{{route('head.store')}}" method="post"> @csrf
                                <div class="form-group">
                                    <label class="form-label">parent group</label>
                                    <select  class="form-control" name="parent_group">
                                    @foreach (DB::table('groups')->get() as $head)
                                        <option value="{{$head->id}}">{{$head->group_name}} </option>
                                    @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Name</label>
                                    <input type="text" class="form-control" name="account_head">
                                </div>
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">Head Component</div>
                        <div class="card-body p-5">
                            <form action="{{route('group.store')}}" method="post"> @csrf
                                <div class="form-group">
                                    <label class="form-label">parent group</label>
                                    <select  class="form-control" name="parent_group">
